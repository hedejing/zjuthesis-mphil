\chapter{\stc{}轮廓线的绘制算法设计与实现}

基于上一章的推导，可知\epsl{}可以通过检查轨迹函数$t(x)$的极值点来在图像空间中完成判定。因此，本文设计来一个算法来实现实时的双目轮廓线绘制，并在运行时完成\epsl{{}的判定。在这一章中，本文将针对\con{}对整个算法流程进行总结，并对流程中每个阶段的细节进行具体的说明，再讲述如何将这套算法拓展至\scon{}上，并实现进一步的线条风格化。

\begin{figure}[tbh]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.2\linewidth]{overview2}}
